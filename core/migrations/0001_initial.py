    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blood_pressure', models.CharField(blank=True, help_text='Format: 120/80 mmHg', max_length=20)),
                ...
                ('lab_test', models.CharField(choices=[('CBC', 'Complete Blood Count (CBC)'), ('CMP', 'Comprehensive Metabolic Panel (CMP)'), ('LIPID', 'Lipid Panel'), ('GLUCOSE', 'Blood Glucose'), ('UA', 'Urinalysis (UA)'), ('TSH', 'Thyroid Stimulating Hormone (TSH)'), ('HBA1C', 'HbA1c'), ('VITD', 'Vitamin D Level'), ('CRP', 'C-Reactive Protein (CRP)'), ('LFT', 'Liver Function Tests (LFTs)')], max_length=20)),
